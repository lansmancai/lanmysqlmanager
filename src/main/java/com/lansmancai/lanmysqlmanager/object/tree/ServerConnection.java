...
import com.lansmancai.lanmysqlmanager.exception.ConnectionException;
...
public class ServerConnection extends ConnectionNode {
	...
	public Connection createConnection(String database) throws Exception {
		Class.forName(DRIVER);
		//System.out.println(getConnectUrl());
		//System.out.println(database);
		//System.out.println(this.username);
		//System.out.println(this.password);
		Connection conn = DriverManager.getConnection(getConnectUrl() + database + "?useSSL=false&serverTimezone=UTC",
